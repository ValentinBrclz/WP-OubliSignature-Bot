...
function isUnsignedComment(line, title, summary, username, content) {
	...
	var regexes = [
		unsigned_regex,
		new RegExp("{{\\s*(__|auteurs crédités après|si|suppression immédiate|speedy|sd|dsi|delete|db|page conservée|avertissement homonymie|traduit de|wikiprojet|À faire|ip scolaire|ip partagée|icône|arbre|wikipédia n'est pas un forum|nobots|bots|Wikidata|boite|boîte|ne pas archiver|marronnier|non signé)", "i"), // modèles
